...
I used to be a GUI Emacs user.\\
The motivation to try out Neovim was the rise of AI agentic workflows, and that the AI agent harnesses worked best in the "proper" terminals (Claude Code was flickering and jumping around in Emacs's vterm, and it wasn't a good experience).\\
...
It's just that I had everything working better for me in Emacs.\\
...
- Emacs also got [[https://github.com/dakra/ghostel][ghostel]] now, which gives me pretty good experience when I use GUI Emacs with embedded terminal (maybe also AI agent harness improved to run smoother)
