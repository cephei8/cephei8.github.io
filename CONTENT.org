...
Check out [[https://sr.ht/~cephei8/greener/][project page]] or [[https://greener.cephei8.dev][documentation]] for details.
...
- SourceHut: [[https://sr.ht/~cephei8/][~cephei8]]
...
- Repositories
  - [[https://sr.ht/~cephei8/greener/][Project]]
  - [[https://git.sr.ht/~cephei8/greener-reporter][Native library for implementing test reporters]]
  - [[https://git.sr.ht/~cephei8/greener-reporter-py][Python package for implementing test reporters]]
  - [[https://git.sr.ht/~cephei8/greener-reporter-js][JavaScript package for implementing test reporters]]
  - [[https://git.sr.ht/~cephei8/pytest-greener][pytest plugin]]
  - [[https://git.sr.ht/~cephei8/jest-greener][Jest reporter]]

*** Feedback and contact information
Let me know your thoughts at [[https://lists.sr.ht/~cephei8/greener-discuss][greener-discuss mailing list]] or [[https://github.com/cephei8/greener/discussions][Greener GitHub Discussions]].
